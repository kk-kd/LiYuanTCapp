package com.liyuaninc.liyuantcapp.Main.Fragments.settingpic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (result) {
            case 0:
                ...
                break;
            case 1:
                if (ContextCompat.checkSelfPermission(emptyactivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
