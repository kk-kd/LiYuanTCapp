package com.liyuaninc.liyuan.ftc_season.season2017;
...
import com.liyuaninc.liyuan.ftc_season.season2016.*;
import com.liyuaninc.liyuan.ftc_season.season_xml_setting.save;

public class season_main_2017 extends AppCompatActivity {
    @Override
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hanhua.setImageResource(R.drawable.rb_bbs);
                view.setText("data");*/
                Intent intent = new Intent(season_main_2017.this, com.liyuaninc.liyuan.ftc_season.season2016.season_data.class);
        ...
        hanhua.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(season_main_2017.this,SDK.class);
                startActivity(intent);
                finish();
            }
        });
